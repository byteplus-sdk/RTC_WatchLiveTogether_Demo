...
@interface LiveShareTextInputView ()
...
@implementation LiveShareTextInputView
...
- (UIImageView *)borderImageView {
    if (!_borderImageView) {
        ...
        _borderImageView.image = [UIImage imageNamed:@"LiveShare_textinput_border" bundleName:HomeBundleName];
    }
...
- (UITextField *)textField {
    if (!_textField) {
        ...
        NSAttributedString *attrString = [[NSAttributedString alloc]
                                          initWithString:LocalizedString(@"say_something")
                                          attributes:
