...
#import "LiveShareTextInputView.h"
#import "LiveShareRTSManager.h"

@interface LiveShareTextInputComponent ()

@property (nonatomic, weak) UIView *superView;
@property (nonatomic, weak) UIView *contentView;
@property (nonatomic, weak) LiveShareTextInputView *textInputView;
@property (nonatomic, strong) LiveShareRoomModel *roomModel;
@property (nonatomic, copy) NSString *textMessage;

@end

@implementation LiveShareTextInputComponent
...
- (void)creatureTextInputView {
    ...
    LiveShareTextInputView *textInputView = [[LiveShareTextInputView alloc] initWithMessage:self.textMessage];
...
- (void)loadDataWithSendeMessage:(NSString *)message {
    [LiveShareRTSManager sendMessage:self.roomModel.roomID
                             message:message
