...
@interface LiveShareCreateRoomTipView ()
...
@implementation LiveShareCreateRoomTipView
...
- (UIImageView *)tipImageView {
    if (!_tipImageView) {
        ...
        _tipImageView.image = [UIImage imageNamed:@"live_share_warning" bundleName:HomeBundleName];
    }
